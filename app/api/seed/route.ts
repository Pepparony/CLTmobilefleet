...
export async function GET() {
  try {
    ...
    const vehicles = await db.collection('fleetVehicles').insertMany([
      {
        ...
        photoUrl: 'https://www.cltmobile.com/landscapesmilinginfiniti 2.jpeg',
        active: true,
      ...
      },
      {
        ...
        photoUrl: 'https://www.cltmobile.com/smilinglandrover.jpeg',
        active: true,
        addedAt: '2025-01-06T09:00:00.000Z',
        addedBy: 'admin@cltmobile.com',
      },
      {
        ...
        photoUrl: 'https://www.cltmobile.com/cadillacPPI.jpeg',
        active: true,
        addedAt: '2025-01-06T09:00:00.000Z',
        addedBy: 'admin@cltmobile.com',
      },
    ...
    const ids = Object.values(vehicles.insertedIds).map(id => id.toString());
    const [van1Id, truck1Id, suvId] = ids;

    // Visits & Reports
    await db.collection('fleetVisits').insertMany([
      // Van #1 — 3 completed
      {
        fleetAccountId: accountId, vehicleId: van1Id,
        scheduledDate: '2025-02-03', status: 'completed',
        ...
        report: {
          ...
          coolantStatus: 'healthy', brakeFluidStatus: 'healthy',
          frontBrakesLife: '8', rearBrakesLife: '9',
          batteryVoltage: '12.7', tireTread: 'healthy',
          oilChanged: true, mileageAtService: '48200',
          additionalConcerns: '',
      ...
      {
        fleetAccountId: accountId, vehicleId: van1Id,
        scheduledDate: '2025-03-03', status: 'completed',
        completedAt: '2025-03-03T10:45:00.000Z',
        mechanicAssigned: 'Spencer Huneycutt - Charlotte',
        report: {
          workPerformed: 'Monthly inspection. No oil change due this visit. Topped off power steering fluid — was slightly low. Checked brake pads, battery, all fluids. Adjusted tire pressures.',
          partsReplaced: '',
          coolantStatus: 'healthy', brakeFluidStatus: 'healthy',
          frontBrakesLife: '7', rearBrakesLife: '8',
          batteryVoltage: '12.6', tireTread: 'healthy',
          oilChanged: false, mileageAtService: '50100',
      ...
      {
        fleetAccountId: accountId, vehicleId: van1Id,
        scheduledDate: '2025-04-07', status: 'completed',
        ...
        report: {
          ...
          coolantStatus: 'healthy', brakeFluidStatus: 'dark-low',
          frontBrakesLife: '7', rearBrakesLife: '7',
          batteryVoltage: '12.5', tireTread: 'healthy',
          oilChanged: true, mileageAtService: '52400',
          ...
          photoCaptions: ['Engine bay post-service', 'Front brake pads — 7mm remaining', 'Brake fluid — dark, flush recommended', 'Alignment correction complete'],
          submittedBy: 'Spencer Huneycutt - Charlotte',
        },
      },
      {
        fleetAccountId: accountId, vehicleId: van1Id,
        scheduledDate: '2025-05-05', status: 'scheduled',
        mechanicAssigned: 'Spencer Huneycutt - Charlotte',
      },
      // Truck #1 — 2 completed
      {
        fleetAccountId: accountId, vehicleId: truck1Id,
        scheduledDate: '2025-02-03', status: 'completed',
        completedAt: '2025-02-03T13:00:00.000Z',
        mechanicAssigned: 'Spencer Huneycutt - Charlotte',
        report: {
          workPerformed: 'Full inspection. Oil and filter changed (0W-20 full synthetic, 6 quarts). Cabin air filter replaced — very dirty. All fluids topped off. Tire pressures adjusted.',
          partsReplaced: 'Oil filter, 6qt Mobil 1 0W-20, Cabin air filter (FRAM CF10285)',
          coolantStatus: 'healthy', brakeFluidStatus: 'healthy',
          frontBrakesLife: '6', rearBrakesLife: '7',
          batteryVoltage: '12.8', tireTread: 'fair',
          oilChanged: true, mileageAtService: '61500',
          additionalConcerns: 'Tire tread measuring fair — approximately 4/32" across all four. Budget for replacement within 6 months.',
          recommendedNextService: 'Tires approaching end of life — plan replacement within 6 months.',
          photos: [
            'https://www.cltmobile.com/Enginebayphoto.jpeg',
            'https://www.cltmobile.com/mustangbrakes.jpeg',
          ],
          photoCaptions: ['Engine bay — post oil change', 'Front brakes — 6mm remaining'],
          submittedBy: 'Spencer Huneycutt - Charlotte',
        },
      },
      {
        ...
        mechanicAssigned: 'Spencer Huneycutt - Charlotte',
        report: {
          workPerformed: 'Replaced all four tires — tread was at wear indicators. Oil change (0W-20, 6qt). Checked all fluids and brakes.',
          partsReplaced: 'x4 Michelin Defender2 LT 265/70R17, Oil filter, 6qt Mobil 1 0W-20',
          coolantStatus: 'healthy', brakeFluidStatus: 'healthy',
          frontBrakesLife: '6', rearBrakesLife: '6',
          batteryVoltage: '12.8', tireTread: 'healthy',
          oilChanged: true, mileageAtService: '63200',
          additionalConcerns: '',
          ...
          photoCaptions: ['Engine bay overview', 'New Michelin Defender2 installed — all four corners', 'Brake pads — 6mm remaining'],
          submittedBy: 'Spencer Huneycutt - Charlotte',
        },
      },
      {
      ...
      // Manager's SUV — 1 completed
      {
        fleetAccountId: accountId, vehicleId: suvId,
        scheduledDate: '2025-03-03', status: 'completed',
        completedAt: '2025-03-03T14:00:00.000Z',
        mechanicAssigned: 'Spencer Huneycutt - Charlotte',
        report: {
          workPerformed: 'Full inspection. Oil and filter changed (0W-20, 4.4qt). Brake fluid flushed — was dark. Tires rotated front to rear. All other fluids healthy.',
          partsReplaced: 'Oil filter, 4.4qt Honda Genuine 0W-20, Brake fluid (DOT 3)',
          coolantStatus: 'healthy', brakeFluidStatus: 'healthy',
          frontBrakesLife: '9', rearBrakesLife: '9',
          batteryVoltage: '12.7', tireTread: 'healthy',
          oilChanged: true, mileageAtService: '28400',
          additionalConcerns: '',
    ...
    return NextResponse.json({
      ...
      login: { email: 'marcus@acmeplumbing.com', accessCode: 'AcmePlumbing2025' },
      vehicles: 3,
      visits: 8,
    });
